<div class="headlines index">
	...
	<tr>
		<td><?php echo h($headline['Headline']['id']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $headline['Headline']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $headline['Headline']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
